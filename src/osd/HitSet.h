...
public:
  ...
  public:
    ...
    public:
      ...
      Decoder(const Decoder &o) : params(NULL) {
	if (o.params) {
	  params = HitSet::Params::create_copy(o.params);
	}
      }
	...
	reset_params(Params::create_copy(o.get_params()));
	return *this;
      }
...
public:
  ...
  public:
    ...
    Params() : HitSet::Params(HitSet::TYPE_BLOOM),
